  ...
  return (
    ...
    <div style={{marginTop:"110px"}}>
      ...
      >
        <div
          style={{
            ...
            background: "black",
            margin: "0 auto",
            boxShadow: "0 3px 10px rgb(0 0 0 / 0.2); /* Add a subtle shadow "
          }}
        >
          <img
            style={{
        ...
        <div style={{ marginTop: "-50px" }}>
          <Button className="buttons" onClick={toggleStream} size="lg">
      ...
      <div className="modal-content"> 
              <h3 style={{position:"relative",bottom:"20px"}}>Model Loading .....</h3>
